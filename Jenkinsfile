                    ...
                    withSonarQubeEnv {
                        ...
                        try {
                            if (isUnix()) {
                                ...
                                bat(/"${mvnHome}\bin\mvn"  sonar:sonar  -Dsonar.projectKey=DGFChatbot  -Dsonar.host.url=http:\\localhost:9000 -Dsonar.login=4d77e8116d228811203c828c59ee74cffedad3b8 -Dmaven.test.failure.ignore=true/)
                            }
